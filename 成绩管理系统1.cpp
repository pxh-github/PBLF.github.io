...
void  weightedscore(STU *head, int n, int m, int w[]);//计算每个学生的加权成绩（加权后满分100） 
...
void  per16_score_correlation(STU *head, int n, int m);       //十六型人格 
...
{
	int i;
	system("title 学生成绩管理系统  By  somebody");
	printf("\n\n");
	printf("\t\t\t                         学生成绩管理系统\n");
	printf("\t\t\t******************************************************************************\n");
